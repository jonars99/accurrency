    ...
    <div className="container-fluid">
      <div id="exchange-page" className="row pb-5 px-4 px-md-5">
        ...
        <div className="col-12 d-flex justify-content-center my-3 my-md-4 mb-xl-0">
          <h1 className="fw-bold p-2 pb-xl-1">exchange rates</h1>
        </div>
        ...
        <div className="col-12">
          <div className="row justify-content-evenly justify-content-md-end justify-content-xl-evenly exchange-block p-2 py-md-4 py-xl-0">
            ...
            <div id="base" className="col-12 col-md-4 col-xl-10 d-flex flex-column base-wrapper mb-3 pb-4 px-sm-5 pb-md-0 px-md-3 m-xl-0 p-xl-0">
              <p className="align-self-center align-self-xl-start fw-light mt-3 mb-0 p-xl-2 px-xl-4">base</p>
              <div className="d-xl-flex base-block my-3">
                <div className="input-border my-3 p-1 my-md-2 my-xl-0 py-xl-0 order-xl-2 px-xl-4">
                  <input className="form-control number-input my-md-3 my-xl-2 text-center text-xl-start" type="number" min="1" value={amount} onChange={handleAmount} ></input>
                </div>
